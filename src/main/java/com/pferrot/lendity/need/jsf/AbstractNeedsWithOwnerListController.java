...
public abstract class AbstractNeedsWithOwnerListController extends AbstractNeedsListController {
	
	private final static Log log = LogFactory.getLog(AbstractNeedsWithOwnerListController.class);
...
//		if (ownerSelectItems == null) {
			ownerSelectItems = UiUtils.getSelectItemsForPerson(getNeedService().getCurrentPersonEnabledConnections());
