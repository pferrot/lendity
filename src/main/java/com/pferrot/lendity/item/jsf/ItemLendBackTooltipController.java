...
public class ItemLendBackTooltipController implements Serializable {
	
	private final static Log log = LogFactory.getLog(ItemLendBackTooltipController.class);
	...
	private void lendBackItem() {
		getItemService().updateLendBackItem(getItemId());		
	}	
}
